...
if (!class_exists("EnYrcWDQuotes")) {
    ...
    class EnYrcWDQuotes
    {
        ...
        public function __construct()
        {
            ...
            add_filter('en_yrc_wd_origin_array_set', array($this, 'en_wd_origin_array_set'), 10, 1);
            add_filter('en_yrc_wd_standard_plans', array($this, 'en_wd_standard_plans'), 10, 4);
