 ...
 * Class EnYrcFreightProductDetail
 * @package EnYrcFreightProductDetail
 */
if (!class_exists('EnYrcFreightProductDetail')) {
    ...
    class EnYrcFreightProductDetail
    {
        ...
        /**
         * Hook for call.
         * EnYrcFreightProductDetail constructor.
         */
        public function __construct()
        {
            add_filter('en_app_common_plan_status', [$this, 'en_yrc_freight_plan_status'], 10, 1);
         ...
         * @return array
         */
        public function en_yrc_freight_plan_status($plan_status)
        {
            $en_plugin_name = 'LTL Freight Quotes – YRC Edition';
            ...
            $plan_status['hazardous_material']['yrc_freight'][] = 'yrc_freight';
        ...
        public function en_app_common_plan_status()
        {
            ...
            if (isset($plan_status['hazardous_material'])) {
                if (!in_array(0, $plan_status['hazardous_material']['plan_required'])) {
                    ...
                    $this->hazardous_plan_required = apply_filters("yrc_quotes_plans_notification_link", [2, 3]);
