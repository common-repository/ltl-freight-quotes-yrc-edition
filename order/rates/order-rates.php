 ...
 */
if (!class_exists('EnYrcOrderRates')) {

    class EnYrcOrderRates
    {
        ...
        public function en_order_before_calculate_totals($and_taxes, $order)
        {
            ...
            if (isset($woocommerce->cart)) {
                    ...
                    foreach ($shipping as $item_id => $per_shipment) {
                        ...
                        switch ($method_id) {
                            case 'yrc':
                                ...
                                if (empty($errors)) {
                                    $shipping_class = new YRC_Freight_Shipping_Class();
                ...
                if ($order_recreated) {
                    ...
                    $yrc_freight_curl_obj = new YRC_Curl_Request();
                    $yrc_freight_curl_obj->yrc_get_curl_response(YRC_FDO_HITTING_URL, $request_data);
                }
            }
        }
    }
