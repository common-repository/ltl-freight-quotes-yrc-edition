...
$get_option = get_option('yrc_quotes_web_hook_plan_requests');
...
update_option('yrc_quotes_web_hook_plan_requests' , json_encode($en_web_hook_requests));
...
{    
    ...
    update_option('yrc_package_expire_days' , "$expire_days");
